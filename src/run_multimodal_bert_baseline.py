...
def run_baselines(
    ...
    # Baseline 1: Frozen BERT embeddings + Causal Forest
    est = CausalForestDML(
        model_y=LassoCV(),
    ...
    # Baseline 2: Frozen BERT embeddings + TARNet (no text finetune)
...
if __name__ == "__main__":
    ...
    cf, tarnet = run_baselines(
        n_samples=args.n_samples, p_noise=args.p_noise, seed=args.seed, model_name=args.model_name, device=device
    )
